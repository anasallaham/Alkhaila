...
{
	'name':"Inventory Adjustments Backdate and Remarks in Odoo",
	'version':'13.0.0.2',
	'category':'Warehouse',
	'description':"""You can create a Backdate order and remarks for Stock Inventory Adjustments
	...
	""",
	'summary':'inventory adjustment backdate stock transfer backdate transfer backdating stock backdate remarks inventory backdate inventory adjustment backdating remarks stock operation backdate receipt backdate stock back-date stock transfer shipment backdate receipt',
	'author':"BrowseInfo",
	...
	'application':True,
	'auto_install':False,
    "live_test_url":'https://youtu.be/188hTwHtnlk',
